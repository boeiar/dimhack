...
const MEMU_STING_DEF ScreenSaver8 [] = "       NM       \2                \2";
const MEMU_STING_DEF ScreenSaver9 [] = "      NARM      \2                \2";
const MEMU_STING_DEF ScreenSaver10[] = "     NX ARM     \2                \2";
const MEMU_STING_DEF ScreenSaver11[] = "    NXP  ARM    \2                \2";
const MEMU_STING_DEF ScreenSaver12[] = "   NXP    ARM   \2       L        \2";
const MEMU_STING_DEF ScreenSaver13[] = "  NXP      ARM  \2      L48       \2";
const MEMU_STING_DEF ScreenSaver14[] = " NXP        ARM \2     LP148      \2";
const MEMU_STING_DEF ScreenSaver15[] = "NXP          ARM\2    LPC2148     \2";
 ...
 *             MEMU_TIME_OUT_DEF * MenuTO
 * Return: none
 * Description: Trim volatage measure
 *
 *************************************************************************/
